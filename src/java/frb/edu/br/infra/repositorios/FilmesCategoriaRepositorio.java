...
public class FilmesCategoriaRepositorio extends DaoUtil implements IFilmeCategoria {
    ...
    public FilmeCategoriaDto getRegistroPorId(int filme_id, int categoria_id) {
        FilmeCategoriaDto filmeCategoria = new FilmeCategoriaDto();
        ...
        CategoriaRepositorio categ = new CategoriaRepositorio();
        try {
            ...
            while (rs.next()) {
                filmeCategoria = new FilmeCategoriaDto(rs.getInt("filme_id"),
                        rs.getInt("categoria_id"),
                        film.getRegistroPorId(rs.getInt("filme_id")),
                        categ.getRegistroPorId(rs.getInt("categoria_id")),
    ...
    public List<FilmeCategoriaDto> getListaTodos() {
        List<FilmeCategoriaDto> filmeCategoria = new LinkedList<FilmeCategoriaDto>();
        ...
        try {
            ...
            while (rs.next()) {
                ...
                CategoriaDto categs = categ.getRegistroPorId(rs.getInt("categoria_id"));
                filmeCategoria.add(new FilmeCategoriaDto(
                        rs.getInt("filme_id"),
                        rs.getInt("categoria_id"),
                        films,
                        categs,
